    ...
    <div className="sidebar">
      ...
      <div className="sb-sec">
        ...
        >
          ...
          >
            <div
              className="sb-env-dot"
              style={{
                background:
                  liveAttendance >= 50 ? "var(--greens)" : "var(--amber)",
        ...
        <div className="card" style={{ padding: 12, borderRadius: 14 }}>
          ...
          >
            <div
              className="sb-env-dot"
              style={{
                background: pendingLeave > 0 ? "var(--red)" : undefined,
                boxShadow:
                  pendingLeave > 0
                    ? "0 6px 14px rgba(239,68,68,.12)"
                    : undefined,
              }}
            />
            <Bell size={13} />
